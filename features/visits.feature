...
Feature: Visits
  ...
  Scenario: Create two visits from different users in the same space
    ...
    When the establishment "wunderbar2" is created
    And the user with email "testing31@gmail.com" visits the space from establishment "wunderbar2"
    And the user with email "testing32@gmail.com" visits the space from establishment "wunderbar2"
