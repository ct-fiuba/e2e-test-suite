...
Then('the code generated by the user with email {string} is in the billboard', function (email) {
  expect(this.billboard).to.include(this.visits[email]['userGeneratedCode']);
});
